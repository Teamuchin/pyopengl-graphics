...
class Camera:
    ...
    def zoom(self, z):
        # Zooming should move the eye along the camera's Z-axis
        move = self.cameraZ * -z # move along the forward vector
